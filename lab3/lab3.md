...
Ні, перехресні посилання немає. Потрібно додати наприклад, з інформаційної статті про стікери (`/articles/funko-stickers-explained`) поставити контекстне посилання на комерційну категорію `/catalog/marvel`, щоб користувач міг одразу придбати фігурки, про які щойно прочитав.
